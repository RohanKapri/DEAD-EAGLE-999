...
class Allergies
{
    public function __construct(private int $allergyScore)
    {
    }

    public function isAllergicTo(Allergen $allergen): bool
    {
        return $this->allergyScore & $allergen->getScore();
    }

    public function getList(): array
    {
        return array_filter(Allergen::allergenList(), function ($item) {
            return $this->isAllergicTo($item);
        });
    }
}
